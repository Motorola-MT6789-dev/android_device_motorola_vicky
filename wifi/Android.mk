...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service-lazy.vicky.rc
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service.vicky.xml
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service-lazy.vicky
...
LOCAL_REQUIRED_MODULES := \
    android.hardware.wifi@1.0-service-lazy.vicky.rc \
    android.hardware.wifi@1.0-service.vicky.xml
